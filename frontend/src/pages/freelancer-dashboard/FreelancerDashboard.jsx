...
const FreelancerDashboard = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      const resCandidaturesNumber = await fetch(
      ...
      const number = await resCandidaturesNumber.json();
      setCandidaturesCount(number);
      ...
      const inProgress = announcements.filter(announcement => announcement.status === "InProgress" || announcement.status === "InProgress_Sent").length;
      const completed = announcements.filter(announcement => announcement.status === "Completed").length;
        ...
        <div className="quick-actions">
          ...
          <div className="actions-grid">
            <button
              ...
              onClick={() => navigate("/announcements-list", { state: {position: "search"} })}
            >
        ...
        <div className="dashboard-sections">
          <div className="dashboard-row">
            <div
              ...
              onClick={() => navigate("/announcements-list", { state: {position: "work"} })}
            >
              <div className="card-header">
                <h3>Progetti a carico</h3>
                <span className="badge">{inProgressCount}</span>
              </div>
              <p>Progetti in lavorazione/completati</p>
            ...
            <div
              className="dashboard-card clickable"
              onClick={() => navigate("/announcements-list", { state: {position: "candidatures"} })}
            >
              <div className="card-header">
                <h3>Candidature Inviate</h3>
                <span className="badge warning">{candidaturesCount}</span>
              </div>
